...
d3.json("matrix_data_12_" + muh + "_" + sigma + ".json", function(data) {
    ...
    //corZscale = d3.scale.linear().domain([-2, -1, 0, 1]).range([ "white", "blue", "red","green"]);
    ...
    matrixplotA.append("text").attr("id", "xaxis").attr("class", "axes").attr("x", w / 2).attr("y", h + pad.bottom * 0.7).text("Fertilisation success (Î´Ïˆ)").attr("dominant-baseline", "middle").attr("text-anchor", "middle").attr("fill", "black");
    matrixplotA.append("text").attr("id", "yaxis").attr("class", "axes").attr("x", -pad.left * 0.8).attr("y", h / 2 + 20).text("Costs of cheating (Î³)").attr("dominant-baseline", "middle").attr("text-anchor", "middle").attr("transform", "rotate(270," + (-pad.left * 0.8) + "," + (h / 2) + ")").attr("fill", "black");
    ...
    matrixplotB.append("text").attr("id", "xaxis").attr("class", "axes").attr("x", w / 2).attr("y", h + pad.bottom * 0.7).text("Fertilisation success (Î´Ïˆ)").attr("dominant-baseline", "middle").attr("text-anchor", "middle").attr("fill", "black");
    matrixplotB.append("text").attr("id", "yaxis").attr("class", "axes").attr("x", -pad.left * 0.8).attr("y", h / 2 + 20).text("Costs of cheating (Î³)").attr("dominant-baseline", "middle").attr("text-anchor", "middle").attr("transform", "rotate(270," + (-pad.left * 0.8) + "," + (h / 2) + ")").attr("fill", "black");
  }   
  );
}
